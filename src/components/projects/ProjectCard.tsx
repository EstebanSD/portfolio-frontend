...
export function ProjectCard({ project }: ProductCardProps) {
  ...
  return (
    // TODO onCLick
    <Card className="max-w-sm md:max-w-md lg:max-w-lg group pt-0 overflow-hidden border-0 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-background">
